                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default painel-css-1">
                            <div class="panel-heading">
                                Atualizar requisição de doação de alimento
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form method="POST" action="atualizar_requisicaoDeDoacaoBD.php" class="form-atualizar-solicitar-doacao" id="form-style">
                                            <div class="form-group hide">
                                                <label>id </label>
                                                <input class="form-control" id="id_requisicao" name="id_requisicao" placeholder="" value='<?php echo $id; ?>' readonly />
                                            </div>
                                            <div class="form-group hide">
                                            ...
                                            <div class="form-row">
                                                <div class="col">
                                                    ...
                                                    <input type="date" class="form-control" id="user_dataLimite_atualizar" name="user_dataLimite_atualizar" value='<?php echo $dataLimiteEntrega; ?>' />
                                                </div>
                                                <div class="col">
                                                    <label>Tipo de alimento</label><br />
                                                    <select class="form-control tipo_alimento_atualizar select-style" name="tipo_alimento_atualizar" required>
                                                        <option value='pereciveis' <?php if ($tipoAlimento == 'pereciveis') { echo "selected"; } ?>> Perecíveis</option>
                                                        <option value='nao-pereciveis' <?php if ($tipoAlimento == 'nao-pereciveis') { echo "selected"; } ?>> Não-perecíveis</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group form-style-select">
                                                <label>Quais alimentos eu preciso?</label>
                                                <textarea type="text" class="form-control" name="user_quaisAlimentos_atualizar" required maxlength="1000"/><?php echo $oque; ?></textarea>
                                            </div>
                                            <div class="form-group form-style-select">
                                                <label>Por que eu preciso desta doação ?</label>
                                                <textarea type="text" class="form-control" name="user_motivacaoParaReceberDoacao_atualizar" required maxlength="1000"/><?php echo $porque; ?></textarea>
                                            </div>
                                            <div class="col-12 center-block">
                                                <button type="submit" class="btn btn-success btn-add2 rounded1" id="btn-atualizar-requisicao-de-doacao">Atualizar requisição</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
