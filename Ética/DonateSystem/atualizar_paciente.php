...
if ($_GET['id'] == 'undefined') {
    header("location: desejo_doar.php");
}
                                    ...
                                    <div class="col-md-12">
                                        <form method="POST" action="atualizar_pacienteBD.php" id="paciente_cadastro_form">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="user_nome" name="user_nome" placeholder="" value='<?php echo $nomePaciente ?>' required />
                                            </div>
                                            <div class="form-group hide">
                                                <input type="email" class="form-control" placeholder="" name="id_paciente" value='<?php echo $id ?>' readonly />
                                            </div>
                                            <div class="form-group hide">
                                                <input type="email" class="form-control" placeholder="" name="user_email_atual" value='<?php echo $emailPaciente ?>' readonly />
                                            </div>
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="email" class="form-control" placeholder="" name="user_email" value='<?php echo $emailPaciente ?>' required />
                                            </div>
                                            <div class="form-row">
                                                <div class="col-4">
                                                    <label>CPF</label>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input type="date" class="form-control" name="user_dataLimite" value='<?php echo $nascimento ?>' />
                                                </div>
                                                <div class="col">
                                                    <label>Telefone</label>
                                                    <input type="text" class="form-control" placeholder="" value='<?php echo $telefone ?>' name="user_telefone" required />
