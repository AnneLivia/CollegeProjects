        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="adjust-nav">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="assets/img/icon_hospital_nav.png" id="iconHopNav" /> &nbsp;DONATE FOOD SYSTEM</a>
                </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="pacientes_ativos.php"><img src="assets/img/icon_patient_menu.png" class="iconMenu" /> Desejo doar </a>
                    </li>
                    <li>
                        <a href="cadastrar_pacientes.php"><img src="assets/img/icon_patient_add_menu.png" class="iconMenu" /> Desejo receber </a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-md-12 main-index-presentation">
                        ...
                        <h3 class="text-center">
                            Este sistema permite a conexão entre o doador e a pessoa que necessita de doações.
                        </h3>
                        <hr/>
                    ...
                    <div class="col-md-12">
                        <h5 class="med_pat_title_table center"><img src="assets/img/icon_titles_emphasis.png" class="title_session" /> &nbsp; ÚLTIMAS DOAÇÕES E REQUISIÇÕES</h5>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
