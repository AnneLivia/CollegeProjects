            ...
            <div class="adjust-nav">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li id="nav_top_style"><a href="settings.php"><img src="assets/img/help.png"/ id="help_icon"></a></li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <h4 class="title-index center"><img src="assets/img/food-donation_general.png" class="title_session" /> &nbsp; ÚLTIMAS DOAÇÕES E REQUISIÇÕES</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <h5 class="title-index">DOAÇÕES</h5>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h5 class="title-index">REQUISIÇÕES</h5>
                            <div class="table-responsive">
