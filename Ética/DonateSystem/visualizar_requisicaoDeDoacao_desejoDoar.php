            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li class="text-center user-image-back">
                        ...
                        // obter os dados do usuario atual
                        $query = "SELECT nome FROM users WHERE email = '$email_requerente'";
                        $select = mysqli_query($conexao, $query);
                        if ($select) {
                            $nome_requerente = mysqli_fetch_array($select)['nome'];
                        }

                        // obter os dados do usuario atual
                        $query = "SELECT telefone FROM users WHERE email = '$email_requerente'";
                        $select = mysqli_query($conexao, $query);
                        if ($select) {
                            $telefone = mysqli_fetch_array($select)['telefone'];
                        }

                        $getTodasConsultas = "SELECT * FROM endereco_user WHERE email = '$email_requerente'";
                                    ...
                                    <div class="col-md-12">
                                        <form method="POST" action="#" class="visualizar-dados-requisicao-de-doacao" id="form-style2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" value='<?php echo $nome_requerente; ?>' readonly />
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
                                                    <label>Email</label>
                                                    <input type="email" class="form-control" value='<?php echo $email_requerente; ?>' readonly />
                                                </div>
                                                <div class="col">
