        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="adjust-nav">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="assets/img/food-donation.png" id="iconHopNav" /> &nbsp;HOSPITAL MANAGEMENT SYSTEM</a>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default painel_paciente_medico">
                            <div class="panel-heading">
                                Desejo Receber no sistema
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form method="POST" action="create_bdPaciente.php" id="paciente_cadastro_form">
                                            <div class="form-group">
                                                <label>Nome Completo</label>
                                                <input class="form-control" id="Paciente_nome" name="Paciente_nome" placeholder="" required />
                                            </div>
                                            <div class="form-group">
                                                <label>Email</label>
                                            ...
                                            <div class="form-row">
                                                <div class="col-4">
                                                    <label>CPF</label>
                                                    <input type="text" class="form-control" placeholder="" name="Paciente_cpf" required />
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="" name="Paciente_telefone" required />
                                            ...
                                            <div class="form-row">
                                                <div class="col">
                                                    <label>CEP</label>
                                                    <input type="text" class="form-control" placeholder="" name="Paciente_cep" required />
                                                </div>
                                                <div class="col">
                                                    <label>Número da casa</label>
                                                    <input type="text" class="form-control" placeholder="" name="Paciente_ncasa" required />
                                                </div>
                                                <div class="col-12 center-block">
                                                    <button type="submit" class="btn btn-success btn-add2 btn-cadastrar-paciente rounded1">Cadastrar</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
