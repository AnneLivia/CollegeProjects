            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <?php
                            if ($genero == 'feminino') {
                                echo '<img class="img-patient-ativos center-block" src="assets/img/food_request_info_girl.png" />';
                            } else {
                                echo '<img class="img-patient-ativos center-block" src="assets/img/food_request_info_boy.png" />';
                            }
                        ?>
                        <h3 class="title_ativos">Todas as minhas solicitações de doação de comida no sistema </h3>
                    </div>
                </div>
                            ...
                            <table class="table_ativos table-ativos-requisicoes-doacao table table-striped table-borderless table-hover">
                                ...
                                <tbody>
                                    ...
                                    if (mysqli_query($conexao, "SELECT * FROM requisicoes_de_doacoes")) {
                                        ...
                                        $getTodosPacientes = "SELECT * FROM requisicoes_de_doacoes WHERE email = '$email'";
                                        ...
                                        if (mysqli_num_rows($select) != 0) {
                                            ...
                                            while ($info = mysqli_fetch_array($select)) {
                                                ...
                                                echo "<tr id='$id'>
                                                        ...
                                                        <td><button class='delete-style-onTable deleteRequestDoacao btn btn-danger rounded1'>X</button></td>
                                                </tr>";
                                            }
                                            $i++;
                                        }
