    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <img class="img-design-ativos center-block" src="assets/img/patient_info.png" />
                                        ...
                                        if (mysqli_num_rows($select) != 0) {
                                            ...
                                            while ($info = mysqli_fetch_array($select)) {
                                                ...
                                                echo "<tr id='$id'>
                                                        ...
                                                        <td>$ncasa</td>
                                                        <td>$telefone</td>
                                                        <td><button class='button-style-onTable deletePaciente btn btn-danger rounded1'>X</button></td>
                                                </tr>";
                                            }
                                            $i++;
                                        }
