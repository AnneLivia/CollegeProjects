...
int main() {
    ...
    cout << "Divisão da soma dos elementos da diagonal principal por 5: " << diagonalP << endl;
    cout << "Multiplicação da soma dos elementos da diagonal segundaria por 5: " << diagonalS << endl;
    return 0;
}
