...
public class CadastroPessoa extends javax.swing.JFrame {
   ...
   int index = 0;
    ...
    private void initComponents() {
        ...
        textArea2.setFont(new java.awt.Font("Comic Sans MS", 0, 14)); // NOI18N

        jLabel1.setFont(new java.awt.Font("Comic Sans MS", 1, 14)); // NOI18N
        jLabel1.setText("Nomes cadastrados");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(textArea2, javax.swing.GroupLayout.PREFERRED_SIZE, 366, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        nomes[index] = JOptionPane.showInputDialog("Digite o nome");
        if(index < 5) {
            if(nomes[index] != null) {
                String exibir = "";
                for(int i = 0; i <= index; i++) {
                    exibir = exibir + nomes[i] + "\n";
                }
                textArea2.setText(exibir);
                index++;
            }
        } else {
