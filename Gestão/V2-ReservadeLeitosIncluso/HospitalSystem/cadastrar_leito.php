                                            ...
                                            <tbody>
                                                ...
                                                if (mysqli_query($conexao, "SELECT * FROM leitos")) {
                                                    ...
                                                    if (mysqli_num_rows($select) != 0) {
                                                        ...
                                                        <td>$status</td>
                                                        <td>$nPacientes</td>
                                                        <td><button class='delete_leito btn btn-danger rounded1'>X</button></td>
                                                    </tr>";
                                                        }
                                                        $i++;
                                                    }
                                    ...
                                    <form method="POST" action="create_bdLeito.php" id="leito_form">
                                        <div class="form-row">
                                            <div class="col-4">
                                                ...
                                                <select class="form-control select-status-leito" name="tipo_leito" required>
                                            ...
                                            <div class="col-4">
                                                ...
                                                <select class="form-control select-status-leito" name="status_leito" required>
                                            ...
                                            <div class="col-2">
                                                ...
                                                <button type="submit" class="btn_cadastrar_leito btn btn-success rounded1">Cadastrar</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
