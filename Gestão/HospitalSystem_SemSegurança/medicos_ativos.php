    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <img class="img-doctor-ativos center-block" src="assets/img/doctor_info.png" />
                        <h3 class="title_ativos">Médicos cadastrados no sistema</h3>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table_ativos  table-ativos-medicos table table table-striped table-borderless table-hover">
                                        ...
                                        if (mysqli_num_rows($select) != 0) {
                                            ...
                                            while ($info = mysqli_fetch_array($select)) {
                                                ...
                                                echo "<tr id='$id'>
                                                        ...
                                                        <td>$telefone</td>
														<td>$especialidade</td>
                                                        <td><button class='delete-style-onTable deleteMedico btn btn-danger rounded1'>X</button></td>
                                                </tr>";
                                            }
                                            $i++;
                                        }
