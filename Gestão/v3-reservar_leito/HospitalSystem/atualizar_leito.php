...
if ($_GET['id'] == 'undefined') {
    header("location: cadastrar_leito.php");
}
    ...
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li class="text-center user-image-back">
                        ...
                        $id = $_GET['id'];
                        $getTodasConsultas = "SELECT * FROM leitos WHERE id = '$id'";
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <img class="img-agenda-ativos center-block" src="assets/img/bed_hosp_info.jpg" />
                        <h2 class="title_ativos-leito">Atualizar dados do leito</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                                <div class="col-md-12">
                                    <form method="POST" action="atualizar_LeitoBD.php" id="leito_form">
                                        <div class="form-row">
                                            <div class="form-group hide">
                                                <input type="text" class="form-control" placeholder="" name="id_leito" value='<?php echo  $id ?>' readonly />
                                            </div>
                                            <div class="form-group hide">
                                                <input type="text" class="form-control npacientes_atualizar_leitos" placeholder="" name="nPacientes" value='<?php echo  $nPacientes ?>' readonly />
                                            </div>
                                            <div class="col-4">
                                                <label>Tipo de Leito</label><br />
                                                <select class="form-control select-leito select-style" name="tipo_leito_atualizar" required readonly>
                                                    <option value='Leito Clínico'selected><?php echo $tipo ?></option>
                                                </select>
                                            </div>
                                            <div class="col-2">
                                                <label>Quantidade</label><br />
                                                <input type="number" class="form-control quantidade_cama_leito_atualizar" placeholder='0' min='0' value=<?php echo $quantidade ?> name="quantidade_leito" required />
                                            </div>
                                            <div class="col-4">
                                                <label>Status</label><br />
                                                <select class="form-control select-status-leito select-style" name="status_leito_atualizar" required>
                                                    ...
                                                    <option value='Bloqueado' <?php if($status == 'Bloqueado') {echo 'selected'; } ?> >Bloqueado</option>
                                                    <option value='Desativado' <?php if($status == 'Desativado') {echo 'selected'; } ?> >Desativado</option>
                                                    <option value='Planejado' <?php if($status == 'Planejado') {echo 'selected'; } ?> >Planejado</option>
                                                </select>
                                            </div>
                                            <div class="col-2">
                                                <label class="hide_label">Email</label>
                                                <button type="submit" id="btn-atualizar-leito" class="btn-add1 btn btn-success rounded1">Atualizar</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
