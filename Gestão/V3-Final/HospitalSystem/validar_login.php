<?php
    ...
    /* 
        ...
        varias outras funcoes podem ser utilizadas
        preg_replace -> The preg_replace() function returns a string or array of 
        strings where all matches of a pattern or list of patterns found in the input are replaced with substrings.
    */
