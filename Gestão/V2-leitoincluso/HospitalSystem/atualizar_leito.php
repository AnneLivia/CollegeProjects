                                    ...
                                    <form method="POST" action="atualizar_LeitoBD.php" id="leito_form">
                                        <div class="form-row">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <select class="form-control select-status-leito" name="tipo_leito_atualizar" required readonly>
                                            ...
                                            <div class="col-4">
                                                ...
                                                <select class="form-control select-status-leito" name="status_leito_atualizar" required>
                                            ...
                                            <div class="col-2">
                                                ...
                                                <button type="submit" class="btn-atualizar-leito btn btn-success rounded1">Atualizar</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
