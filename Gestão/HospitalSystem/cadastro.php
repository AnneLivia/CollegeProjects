                    ...
                    <div class="form-group">
                        ...
                        <div class="radio">
                            <label id="optionsradio_label1">
                                <input type="radio" name="adm_sexo" id="optionsRadios1" value="feminino" checked /> <img src="assets/img/fem_gender_icon.png" id="genderFemaleIconCadastrar"/> &nbsp; Feminino
                            </label>
                        </div>
                        <div class="radio">
                            <label id="optionsradio_label2">
                                <input type="radio" name="adm_sexo" id="optionsRadios2" value="masculino" /> <img src="assets/img/male_gender_icon.png" id="genderMaleIconCadastrar"/> &nbsp; Masculino
                            </label>
                        </div>
                    </div>
