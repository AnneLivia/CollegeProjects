    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h5 class="med_pat_title_table center"><img src="assets/img/icon_titles_emphasis.png" class="title_session" /> &nbsp; Índices de acesso do sistema</h5>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h5 class="med_pat_title_table center"><img src="assets/img/icon_titles_emphasis.png" class="title_session" /> &nbsp; Índices das consultas</h5>
                        <div class="panel panel-primary painel-graph">
                            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h5 class="med_pat_title_table center"><img src="assets/img/icon_titles_emphasis.png" class="title_session" /> &nbsp; Estatísticas dos atendimentos</h5>
                        <div class="panel panel-primary painel-graph">
                            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h5 class="med_pat_title_table center"><img src="assets/img/icon_titles_emphasis.png" class="title_session" /> &nbsp; Estatísticas de médicos</h5>
                        <div class="panel panel-primary painel-graph">
                            <div class="panel-body">
