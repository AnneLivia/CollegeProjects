...
<div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <img class="img-appoint-ativos center-block" src="assets/img/medicalAppointment_info.png" />
                        <h2 class="title_ativos">Consulta dos Pacientes</h2>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table_ativos table table-striped table-borderless table-hover">
                                        ...
                                        if (mysqli_num_rows($select) != 0) {
                                            ...
                                            while ($info = mysqli_fetch_array($select)) {
                                                ...
                                                echo "<tr id='$id'>
                                                        ...
                                                        <td>$receita</td>
                                                        <td>$diagnostico</td>
                                                        <td><button class='delete_avaliacao btn btn-danger rounded1'>X</button></td>
                                                    </tr>";
                                            }
                                            $i++;
                                        }
